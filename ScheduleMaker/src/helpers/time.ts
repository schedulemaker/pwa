...
export function TimeAgoFromNow(time) {
    const now = Math.floor(Date.now() / 1000)
    const dif = now - time
    var aDay = dif * 1000
    time =  new Date(Date.now() - aDay);
...
// console.log("test time", timeAgo(1568804800))
// console.log("test time222", timeAgo(1568804800))
// console.log("test 333", timeAgo(1576344166))
